 ...
 * @author Propietario
 */
public class modelosCuadroLista extends javax.swing.JFrame {

    /**
     * Creates new form modelosCuadroLista
     */
    public modelosCuadroLista() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modelosCuadroLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modelosCuadroLista().setVisible(true);
            }
        });
    }
